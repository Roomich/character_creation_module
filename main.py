...
class Character:
    ...
    def special(self):
        return (f'{self.name} применил специально умение '
...
def choice_char_class(char_name: str) -> Character:
    ...
    while approve_choice != 'y':
        selected_class = input('Введли название персонажа, '
...
if __name__ == '__main__':
    ...
    warrior_one = choice_char_class(char_name)
    start_training(warrior_one)
